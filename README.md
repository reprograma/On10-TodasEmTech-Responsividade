# Todas em Tech - turma Online 10


## Conteúdo - Aulas 27 de março e 01 de abril
...
## Retomando as aulas passadas
**HTML e CSS**
---
## Intervalo - 15 min
---

## Um pouquinho mais de HTML
- [] criando um formulário `form`
  - [] inputs(campos de texto), labels(etiquetas) e principais propriedades
  - [] criando botões `button`
- [] criando uma `nav` (barra de navegação) e um `footer`(rodapé)
